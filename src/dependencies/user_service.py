...
async def get_service(cache: CacheDep, client: ClientDep, coordinator: CoordinatorDep) -> UserService:
    return UserService(cache=cache, client=client, coordinator=coordinator)
